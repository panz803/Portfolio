            ...
            <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6 text-right">
                            ...
                            $result = mysqli_query($conn, "SELECT COUNT(*) AS total FROM shop WHERE flag = 1");
                ...
                <?php 
                    include("mysql.inc.php");
                    $result = mysqli_query($conn, "SELECT img, title, info FROM shop WHERE flag = 1");
                    while( $row = mysqli_fetch_array($result) ){
                        echo '<br><br><br><br><br><br>';
                        echo '<div class = "col-12 col-sm-4">';
                        echo '<img class="rounded" src="images/shop/'.$row[0].'" style="max-width:100%">';
                        echo '<strong><p>'.nl2br($row[1]).'</p></strong>';
                        echo '<p>'.nl2br($row[2]).'</p><br><br><br>';
                        echo '</div>';
                    }
                ?>
