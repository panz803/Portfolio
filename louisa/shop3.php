            ...
            <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6 text-right">
                            ...
                            $result = mysqli_query($conn, "SELECT COUNT(*) AS total FROM shop WHERE flag = 3");
                ...
                <div class = "col-12 col-sm-3">
                    <br><br><img class="text-left" src = "images/shop/7.jpg" width="256" height="256">
                </div>

                    <!--資料庫讀取-->
                    <?php 
                        include("mysql.inc.php");
                        $result = mysqli_query($conn, "SELECT info FROM shop WHERE flag = 3");
